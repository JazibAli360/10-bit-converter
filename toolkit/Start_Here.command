...
# --- 5. Optional: real drag-and-drop into the GUI ---
if [[ -n "$PYBIN" ]] && ! "$PYBIN" -c "import tkinterdnd2" >/dev/null 2>&1; then
  if ask "Enable drag-and-drop into the app (optional, installs tkinterdnd2)?"; then
